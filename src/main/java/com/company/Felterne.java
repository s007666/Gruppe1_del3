...
public class Felterne {

    public static void main(String[] args) {

        GUI gui = new GUI();

        // Ændrer titlen på felt 1 (efter start)
        gui.getFields()[1].setTitle("Burgerbaren");

        // Fjerner undertitlen på felt 1
        gui.getFields()[1].setSubText("M1");

        // Ændrer farverne på det felt 1, skrift og baggrund
        gui.getFields()[1].setForeGroundColor(Color.BLACK);
        gui.getFields()[1].setBackGroundColor(Color.GREEN);

        // Ændrer beskrivelsen på det første felt 1
